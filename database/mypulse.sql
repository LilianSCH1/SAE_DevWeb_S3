...
CREATE TABLE IF NOT EXISTS `artiste` (
  ...
  `StatusArtiste` enum('en_attente','valide','refusee','classement','archive_suppr', 'archive_classement') NOT NULL DEFAULT 'en_attente',
  `UserID` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `groupe` (
  ...
  `StatusGroupe` enum('en_attente','valide','refusee','classement','archive_suppr', 'archive_classement') NOT NULL DEFAULT 'en_attente',
  `UserID` int NOT NULL,
  `DateProposition` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `musique` (
  ...
  `StatusMusique` enum('en_attente','valide','refusee','classement','archive_suppr', 'archive_classement') NOT NULL DEFAULT 'en_attente',
  `UserID` int NOT NULL,
  `DateProposition` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
